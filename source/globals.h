...
extern int metronome_tempo;
extern int metronome_weak_note;
extern int metronome_strong_note;
extern int metronome_pattern_size;
extern int metronome_velocity;
extern int metronome_channel;
